 ...
 * Fecha de asignacion: 24 de agosto del 2015
...
{
    public partial class frmReporteFechaHora : Form
    {
        public frmReporteFechaHora()
        {
            InitializeComponent();
        ...
        void funFecha()
        {
            ...
            PdfWriter writer = PdfWriter.GetInstance(doc, new FileStream("Reporte, Fecha " + sDia + ".pdf", FileMode.Create));
            doc.AddTitle("Reporte Fecha " + sDia);
            ...
            Paragraph parrafoTitulo = new Paragraph("Reporte Fecha: \n" + sDia, fFontTitulo);
            ...
            try
            {
                MySqlCommand mComando = new MySqlCommand(String.Format("SELECT MaPERSONA.ncodpersona, MaPERSONA.cnombrepersona, MaPERSONA.capellidopersona, MaPERSONA.cdpipersona, MaPERSONA.cnitpersona, MaPERSONA.dfechanacpersona FROM MaPERSONA, TrCITA, TrPACIENTE WHERE MaPERSONA.ncodpersona = TrPACIENTE.ncodpersona and TrPACIENTE.ncodpaciente = TrCITA.ncodpaciente and TrCITA.dfechacita = '{0}'", sDia), clasConexion.funConexion());
